...
function ItemForm({ addItem, initialValues = null, isEdit = false }) {
  ...
  const handleSubmit = (e) => {
    ...
    const item = {
      // preserve original id and createdAt if editing
      ...(initialValues || {}),
      name,
      location,
      status,
  ...
  const handleImageUpload = (e) => {
    ...
    if (file) {
      ...
      if (sizeMB > MAX_MB) {
        setImageError(`File too large (${sizeMB.toFixed(1)} MB). Max is ${MAX_MB} MB.`)
        e.target.value = ""
        return
      }
    ...
    <div style={{
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div>
          ...
          <textarea
            placeholder="Color, brand, markings, any extra details..."
            value={description}
